        ...
        if(isset($_SESSION["adminId"])){
          ...
          <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li class="">
                        <a data-toggle="tooltip" data-placement="bottom" title="" href="<?php echo URL?>register/staff">
                           Staff </a>
                      </li>
                      <li class="">
                      <a data-toggle="tooltip" data-placement="bottom" title="" href="<?php echo URL?>register/student">
                         Student Admission  </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li class="">
                        <a data-toggle="tooltip" data-placement="bottom" title="" href="<?php echo URL?>register/updateStaff">
                           Staff </a>
                      </li>
                      <li class="">
                      <a data-toggle="tooltip" data-placement="bottom" title="" href="<?php echo URL?>register/updateStudent">
                        Student Admission </a>
                      </li>
                    </ul>
                  </li>
